...
namespace Checkpoints
{
    ...
    // LGT: synchronized checkpoint (centrally broadcasted)
    ...
    // LGT: get last synchronized checkpoint
    ...
    // LGT: only descendant of current sync-checkpoint is allowed
    ...
    // LGT: reset synchronized checkpoint to last hardened checkpoint
...
//#1
// LGT: sync-checkpoint master key
...
// LGT: verify signature of sync-checkpoint message
...
// LGT: process synchronized checkpoint
