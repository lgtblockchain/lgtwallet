...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LGT");
    case mBTC: return QString("mLGT");
    case uBTC: return QString::fromUtf8("μLGT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LGTs");
    case mBTC: return QString("Milli-LGTs (1 / 1,000)");
    case uBTC: return QString("Micro-LGTs (1 / 1,000,000)");
    default: return QString("???");
    }
}
