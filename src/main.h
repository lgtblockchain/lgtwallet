...
static const int64 MAX_MONEY = 368000000 * COIN;
static const int64 MAX_MINT_PROOF_OF_WORK = 9999 * COIN;
static const int64 MIN_TXOUT_AMOUNT = MIN_TX_FEE;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY_LGT = 10;
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 1 * 60; // 10-minute block spacing
static const int STAKE_MIN_AGE = 60 * 60 * 3; // minimum age for coin age
static const int STAKE_MAX_AGE = 60 * 60 * 6; // stake age of full weight
static const int64 GENESIS_BLOCK_TIME = 1504873200;
...
static const uint256 hashGenesisBlockOfficial("0x000000007f1eb02b6db728676cbe8f063eb9082a8a8cc537495f8619829b985b");
...
public:
    ...
    {
        // LGT: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // LGT: get transaction coin age
...
public:
    ...
    // LGT: block signature - signed by coin base txout[0]'s owner
    ...
    // LGT: two types of block: proof-of-work or proof-of-stake
    ...
    // LGT: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // LGT: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // LGT: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // LGT: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // LGT: block index flags
    enum  
    {
